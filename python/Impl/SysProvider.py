...
class SysProvider():
    ...
    def UpdateSystem(self,textFilterNoticeUrl:str, textReplaceNoticeUrl:str,imageFilterNoticeUrl:str, imageClassifyNoticeUrl:str
                , imageTempPath:str, skipword:str):
        """     * 更新系统
        ...
        dictionary={
            ...
            'imageFilterNoticeUrl':imageFilterNoticeUrl,
            'imageClassifyNoticeUrl':imageClassifyNoticeUrl,
    ...
    def UpdateLicence(self,txt:str):
        '更新许可'
        dictionary={'Licence':txt}
        result=doPost(self.__textFilterConfig,self.__UpdateLicenceUrl,dictionary)
        return json.loads(result)
