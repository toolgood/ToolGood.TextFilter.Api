...
namespace ToolGood.TextFilter.Api.Impl
{
    public class SysProvider : ProviderBase, ISysProvider
    {
        ...
        public CommonResult UpdateSystem(string textFilterNoticeUrl, string textReplaceNoticeUrl, string imageFilterNoticeUrl
            , string imageClassifyNoticeUrl, string imageTempPath, string skipword)
        {
            ...
            dict["imageFilterNoticeUrl"] = imageFilterNoticeUrl;
            dict["imageClassifyNoticeUrl"] = imageClassifyNoticeUrl;
            dict["imageTempPath"] = imageTempPath;
            dict["skipword"] = skipword;
            var json = JsonConvert.SerializeObject(dict);
            return PostContent<CommonResult>(UpdateSystemUrl, json);
        }
        public Task<CommonResult> UpdateSystemAsync(string textFilterNoticeUrl, string textReplaceNoticeUrl, string imageFilterNoticeUrl
            , string imageClassifyNoticeUrl, string imageTempPath, string skipword)
        {
            Dictionary<string, string> dict = new Dictionary<string, string>();
            dict["textFilterNoticeUrl"] = textFilterNoticeUrl;
