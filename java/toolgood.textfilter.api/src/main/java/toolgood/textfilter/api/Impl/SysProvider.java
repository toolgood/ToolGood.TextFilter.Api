...
public class SysProvider extends ProviderBase implements ISysProvider {
    ...
    private final String UpdateLicenceUrl = "/api/sys-Update-Licence";
    private final String InitDataUrl = "/api/sys-init-Data";
    private final String GCCollectUrl = "/api/sys-GC-Collect";

    @Override
    public CommonResult UpdateSystem(String textFilterNoticeUrl, String textReplaceNoticeUrl,
            String imageFilterNoticeUrl, String imageClassifyNoticeUrl, String imageTempPath, String skipword) {
        ...
        dictionary.put("imageFilterNoticeUrl", imageFilterNoticeUrl);
        dictionary.put("imageClassifyNoticeUrl", imageClassifyNoticeUrl);
        dictionary.put("imageTempPath", imageTempPath);
    ...
    public CommonResult UpdateLicence(String lic) {
        Map<String, Object> dictionary = new Hashtable<String, Object>();
        dictionary.put("Licence", lic);
        String content = doPost(UpdateLicenceUrl, dictionary);
