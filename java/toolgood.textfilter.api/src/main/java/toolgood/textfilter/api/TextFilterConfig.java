...
import toolgood.textfilter.api.Grpcs.ImageClassifyGrpcProvider;
import toolgood.textfilter.api.Grpcs.ImageFilterGrpcProvider;
...
import toolgood.textfilter.api.Impl.ImageFilterAsyncProvider;
import toolgood.textfilter.api.Impl.ImageFilterProvider;
...
public class TextFilterConfig {
    ...
    public IImageFilterProvider CreateImageFilterProvider() {
        return new ImageFilterProvider(this);
    }

    public IImageFilterAsyncProvider CreateImageFilterAsyncProvider() {
        return new ImageFilterAsyncProvider(this);
    }
    ...
    public ImageFilterGrpcProvider CreateImageFilterGrpcClient() {
        return new ImageFilterGrpcProvider(GetGrpcHost().replace("http://", ""));
    }

    public ImageClassifyGrpcProvider CreateImageClassifyGrpcClient() {
        return new ImageClassifyGrpcProvider(GetGrpcHost().replace("http://", ""));
    }
